...
<head>
  ...
  <title>PIYUSH Instagram Messaging Bot</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet">
  <style>
    body {
      background-color: https://i.ibb.co/nN0tkm2p/IMG-20250303-175858-693.webp;
    }
    .container {
      max-width: 500px;
...
<body>
  <div class="container">
    <h1 class="text-center mb-4"> 😈PIYISH Instagram Messaging Bot</h1>
